"""Copy of ``worlds/metroidprime/NotificationManager.py`` (PLAN.md section
J deliverable 2). Pure queue/cooldown logic with no Dolphin dependency, so
it is copied verbatim (only the module docstring differs).
"""
